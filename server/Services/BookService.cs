...
namespace server.Services
{
    ...
    public class BookService : IBookService
    {
        ...
        public BookService(IBookRepo bookRepo, IAuthorRepo authorRepo, IPublisherRepo publisherRepo, ITagRepo tagRepo, IReviewRepo reviewRepo)
        {
            _bookRepo = bookRepo;
        ...
        {
            return await _bookRepo.GetPageWiseBooksAsync(page, pageSize, genresList, authorsList);
        }
        ...
        {
            return await _reviewRepo.PostUserReviewAsync(userEmail, bookId, rating, review);
        }
        ...
        public Task<List<UserReview>> GetReviews(int bookId)
        {
